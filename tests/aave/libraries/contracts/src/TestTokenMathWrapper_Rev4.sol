...
contract TestTokenMathWrapper_Rev4 {
     ...
     */
    function getCollateralMintScaledAmount(uint256 amount, uint256 index) external pure returns (uint256) {
     ...
     */
    function getCollateralBurnScaledAmount(uint256 amount, uint256 index) external pure returns (uint256) {
     ...
     */
    function getCollateralTransferScaledAmount(uint256 amount, uint256 index) external pure returns (uint256) {
     ...
     */
    function getCollateralBalance(uint256 scaledAmount, uint256 index) external pure returns (uint256) {
     ...
     * @return Scaled amount to mint.
     */
    function getDebtMintScaledAmount(uint256 amount, uint256 index) external pure returns (uint256) {
     ...
     * @return Scaled amount to burn.
     */
    function getDebtBurnScaledAmount(uint256 amount, uint256 index) external pure returns (uint256) {
     ...
     */
    function getDebtBalance(uint256 scaledAmount, uint256 index) external pure returns (uint256) {
