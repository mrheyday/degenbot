...
library LiquidationLogic {
    ...
    function executeEliminateDeficit(
        ...
        IAToken(reserveCache.aTokenAddress)
            .burn(params.user, reserveCache.aTokenAddress, balanceWriteOff, reserveCache.nextLiquidityIndex);
    ...
    function executeLiquidationCall(
        ...
        vars.borrowerReserveDebt = IVariableDebtToken(vars.debtReserveCache.variableDebtTokenAddress)
            .scaledBalanceOf(params.borrower).rayMul(vars.debtReserveCache.nextVariableBorrowIndex);
        ...
        if (hasNoCollateralLeft && borrowerConfig.isBorrowingAny()) {
            _burnBadDebt(
                reservesData, reservesList, borrowerConfig, params.borrower, params.interestRateStrategyAddress
            );
        }
        ...
        if (liquidatorPreviousATokenBalance == 0) {
            ...
            if (ValidationLogic.validateAutomaticUseAsCollateral(
                ...
                liquidatorConfig.setUsingAsCollateral(
                    collateralReserve.id, params.collateralAsset, params.liquidator, true
                );
            }
        }
    }
...
import {
    IPoolDataProvider as IAaveProtocolDataProvider
} from "aave-v3-origin/contracts/interfaces/IPoolDataProvider.sol";
...
library ValidationLogic {
    ...
    function validateBorrow(
        ...
        require(
            vars.healthFactor > HEALTH_FACTOR_LIQUIDATION_THRESHOLD, Errors.HealthFactorLowerThanLiquidationThreshold()
        );
...
library SupplyLogic {
    ...
    function executeSupply(
        ...
        bool isFirstSupply = IAToken(reserveCache.aTokenAddress)
            .mint(params.user, params.onBehalfOf, params.amount, reserveCache.nextLiquidityIndex);
    ...
    function executeWithdraw(
        ...
        IAToken(reserveCache.aTokenAddress)
            .burn(params.user, params.to, amountToWithdraw, reserveCache.nextLiquidityIndex);
...
library BorrowLogic {
    ...
    function executeRepay(
        ...
        if (params.useATokens) {
            IAToken(reserveCache.aTokenAddress)
                .burn(params.user, reserveCache.aTokenAddress, paybackAmount, reserveCache.nextLiquidityIndex);
