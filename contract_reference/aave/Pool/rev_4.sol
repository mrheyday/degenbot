...
library BorrowLogic {
    ...
    function executeRepay(
        ...
        reserve.updateInterestRatesAndVirtualBalance(
            reserveCache, params.asset, params.useATokens ? 0 : paybackAmount, 0
        );
        ...
        if (params.useATokens) {
            IAToken(reserveCache.aTokenAddress)
                .burn(msg.sender, reserveCache.aTokenAddress, paybackAmount, reserveCache.nextLiquidityIndex);
    ...
    function executeSwapBorrowRateMode(
        ...
        if (interestRateMode == DataTypes.InterestRateMode.STABLE) {
            (reserveCache.nextTotalStableDebt, reserveCache.nextAvgStableBorrowRate) =
                IStableDebtToken(reserveCache.stableDebtTokenAddress).burn(user, stableDebt);
...
abstract contract Pool is VersionedInitializable, PoolStorage, IPool {
    ...
    function swapBorrowRateMode(address asset, uint256 interestRateMode) public virtual override {
        BorrowLogic.executeSwapBorrowRateMode(
            _reserves[asset], _usersConfig[msg.sender], asset, msg.sender, DataTypes.InterestRateMode(interestRateMode)
        );
    }
    ...
    function swapToVariable(address asset, address user) public virtual override {
        BorrowLogic.executeSwapBorrowRateMode(
            _reserves[asset], _usersConfig[user], asset, user, DataTypes.InterestRateMode.STABLE
        );
    }
...
library ValidationLogic {
    ...
    function validateBorrow(
        ...
        if (params.isolationModeActive) {
            ...
            require(
                reservesData[params.isolationModeCollateralAddress].isolationModeTotalDebt
                        ...
                        .toUint128() <= params.isolationModeDebtCeiling,
        ...
        vars.amountInBaseCurrency = IPriceOracleGetter(params.oracle)
            .getAssetPrice(vars.eModePriceSource != address(0) ? vars.eModePriceSource : params.asset) * params.amount;
        unchecked {
    ...
    function validateSwapRateMode(
        ...
        (bool isActive,,, bool stableRateEnabled, bool isPaused) = reserveCache.reserveConfiguration.getFlags();
        require(isActive, Errors.RESERVE_INACTIVE);
        require(!isPaused, Errors.RESERVE_PAUSED);
    ...
    function validateAutomaticUseAsCollateral(
        ...
        if (reserveConfig.getDebtCeiling() != 0) {
            ...
            if (!IAccessControl(addressesProvider.getACLManager())
                    .hasRole(ISOLATED_COLLATERAL_SUPPLIER_ROLE, msg.sender)) return false;
        }
...
library SupplyLogic {
    ...
    function executeSupply(
        ...
        bool isFirstSupply = IAToken(reserveCache.aTokenAddress)
            .mint(msg.sender, params.onBehalfOf, params.amount, reserveCache.nextLiquidityIndex);
    ...
    function executeWithdraw(
        ...
        IAToken(reserveCache.aTokenAddress)
            .burn(msg.sender, params.to, amountToWithdraw, reserveCache.nextLiquidityIndex);
...
library FlashLoanLogic {
    ...
    function executeFlashLoan(
        ...
        require(
            vars.receiver
            .executeOperation(params.assets, params.amounts, vars.totalPremiums, msg.sender, params.params),
...
library AaveV3EthereumAssets {
    ...
    address internal constant WETH_INTEREST_RATE_STRATEGY = 0x06B1Ec378618EA736a65395eA5CAB69A2410493B;
    ...
    address internal constant wstETH_INTEREST_RATE_STRATEGY = 0x7b8Fa4540246554e77FCFf140f9114de00F8bB8D;
    ...
    address internal constant USDC_INTEREST_RATE_STRATEGY = 0xd56eE97960b1b2953e751151Fd84888cF3F3b521;
    ...
    // https://etherscan.io/address/0x24701A6368Ff6D2874d6b8cDadd461552B8A5283
    address internal constant AAVE_INTEREST_RATE_STRATEGY = 0x24701A6368Ff6D2874d6b8cDadd461552B8A5283;
    ...
    // https://etherscan.io/address/0x24701A6368Ff6D2874d6b8cDadd461552B8A5283
    address internal constant cbETH_INTEREST_RATE_STRATEGY = 0x24701A6368Ff6D2874d6b8cDadd461552B8A5283;
    ...
    address internal constant USDT_INTEREST_RATE_STRATEGY = 0xc7b53C7d24164FB78F57Ea3b5d056bD2E541013d;
    ...
    // https://etherscan.io/address/0x24701A6368Ff6D2874d6b8cDadd461552B8A5283
    address internal constant rETH_INTEREST_RATE_STRATEGY = 0x24701A6368Ff6D2874d6b8cDadd461552B8A5283;
    ...
    address internal constant LUSD_INTEREST_RATE_STRATEGY = 0xb96c569Ceb49440731DdD5D8c5E6DA3538f1CBF1;
    ...
    // https://etherscan.io/address/0xf6733B9842883BFE0e0a940eA2F572676af31bde
    address internal constant ONE_INCH_INTEREST_RATE_STRATEGY = 0xf6733B9842883BFE0e0a940eA2F572676af31bde;
    ...
    address internal constant FRAX_INTEREST_RATE_STRATEGY = 0x7448ABeD12d8538efC115af4a417e3d1367180fc;
    ...
    address internal constant sDAI_INTEREST_RATE_STRATEGY = 0xdef8F50155A6cf21181E29E400E8CffAE2d50968;
    ...
    address internal constant crvUSD_INTEREST_RATE_STRATEGY = 0xaEc90D2516c79F8Ae7165574a41EC4dF2631b36f;
    ...
    // https://etherscan.io/address/0xaEc90D2516c79F8Ae7165574a41EC4dF2631b36f
    address internal constant PYUSD_INTEREST_RATE_STRATEGY = 0xaEc90D2516c79F8Ae7165574a41EC4dF2631b36f;
    ...
    address internal constant weETH_INTEREST_RATE_STRATEGY = 0x48AF11111764E710fcDcE2750db848C63edab57B;
}
...
library LiquidationLogic {
    ...
    function executeLiquidationCall(
        ...
        debtReserve.updateInterestRatesAndVirtualBalance(
            vars.debtReserveCache, params.debtAsset, vars.actualDebtToLiquidate, 0
        );
...
} from "aave-v3-origin/core/contracts/protocol/libraries/configuration/ReserveConfiguration.sol";
...
library PoolRevisionFourInitialize {
    ...
    function initialize(
        ...
        for (uint256 i = 0; i < reservesCount; i++) {
            ...
            if (currentReserveAddress == address(0) || currentReserveAddress == AaveV3EthereumAssets.GHO_UNDERLYING) {
                continue;
            }
            ...
            uint256 balanceOfUnderlying = IERC20(currentReserveAddress).balanceOf(reserveCache.aTokenAddress);
            ...
            uint256 accruedToTreasury =
                WadRayMath.rayMul(currentReserve.accruedToTreasury, reserveCache.nextLiquidityIndex);

            uint256 currentVirtualBalance =
...
library IsolationModeLogic {
    ...
    function updateIsolatedDebtIfIsolated(
        ...
        if (isolationModeActive) {
            ...
            uint128 isolatedDebtRepaid = (repayAmount / 10
                    ** (reserveCache.reserveConfiguration.getDecimals() - ReserveConfiguration.DEBT_CEILING_DECIMALS))
            .toUint128();
