...
library BorrowLogic {
    ...
    function executeRepay(
        ...
        ValidationLogic.validateRepay(
            reserveCache, params.amount, params.interestRateMode, params.onBehalfOf, variableDebt
        );
...
library LiquidationLogic {
    ...
    function executeEliminateDeficit(
        ...
        if (reserveCache.reserveConfiguration.getIsVirtualAccActive()) {
            ...
            IAToken(reserveCache.aTokenAddress)
                .burn(msg.sender, reserveCache.aTokenAddress, balanceWriteOff, reserveCache.nextLiquidityIndex);
        } else {
    ...
    function executeLiquidationCall(
        ...
        if (
            ...
            bool isDebtMoreThanLeftoverThreshold =
                ((vars.userReserveDebt - vars.actualDebtToLiquidate) * vars.debtAssetPrice) / vars.debtAssetUnit
                    >= MIN_LEFTOVER_BASE;
            ...
            require(
                isDebtMoreThanLeftoverThreshold && isCollateralMoreThanLeftoverThreshold, Errors.MUST_NOT_LEAVE_DUST
            );
        }
        ...
        while (vars.i < params.reservesCount) {
            ...
            if (params.userConfig.isBorrowing(vars.i)) {
                if (currentReserve.configuration.getIsVirtualAccActive()) {
                    ...
                    vars.totalDebtInBaseCurrency += (IERC20(currentReserve.variableDebtTokenAddress)
