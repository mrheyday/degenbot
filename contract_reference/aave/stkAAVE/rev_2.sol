...
interface IGovernancePowerDelegationToken {
     ...
     *
     */
    function getPowerCurrent(address user, DelegationType delegationType) external view virtual returns (uint256);
 ...
 *
 */
contract StakedTokenV2 is IStakedAave, GovernancePowerWithSnapshot, VersionedInitializable, AaveDistributionManager {
    using SafeMath for uint256;
