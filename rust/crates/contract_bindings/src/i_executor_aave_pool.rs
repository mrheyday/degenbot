...
```*/
    ...
    ///Container for all the [`IExecutorAavePool`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IExecutorAavePoolCalls {
        #[allow(missing_docs)]
        flashLoan(flashLoanCall),
    }
    impl IExecutorAavePoolCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[171u8, 156u8, 75u8, 93u8]];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IExecutorAavePoolCalls {
        const NAME: &'static str = "IExecutorAavePoolCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IExecutorAavePoolCalls>] = &[
                {
                    fn flashLoan(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IExecutorAavePoolCalls> {
                        <flashLoanCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IExecutorAavePoolCalls::flashLoan)
                    }
                    flashLoan
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IExecutorAavePool`](self) contract instance.

See the [wrapper's documentation](`IExecutorAavePoolInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> IExecutorAavePoolInstance<P, N> {
        IExecutorAavePoolInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IExecutorAavePoolInstance<P, N>>,
    > {
        IExecutorAavePoolInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IExecutorAavePoolInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`IExecutorAavePool`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IExecutorAavePool`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IExecutorAavePoolInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IExecutorAavePoolInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IExecutorAavePoolInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IExecutorAavePoolInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IExecutorAavePoolInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IExecutorAavePoolInstance<P, N> {
            IExecutorAavePoolInstance {
