...
```*/
    ...
    ///Container for all the [`IMevSafeERC1271`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IMevSafeERC1271Calls {
        #[allow(missing_docs)]
        isValidSignature(isValidSignatureCall),
    }
    impl IMevSafeERC1271Calls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IMevSafeERC1271Calls {
        const NAME: &'static str = "IMevSafeERC1271Calls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IMevSafeERC1271Calls>] = &[
                {
                    fn isValidSignature(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IMevSafeERC1271Calls> {
                        <isValidSignatureCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMevSafeERC1271Calls::isValidSignature)
                    }
                    isValidSignature
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IMevSafeERC1271`](self) contract instance.

See the [wrapper's documentation](`IMevSafeERC1271Instance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> IMevSafeERC1271Instance<P, N> {
        IMevSafeERC1271Instance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IMevSafeERC1271Instance<P, N>>,
    > {
        IMevSafeERC1271Instance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IMevSafeERC1271Instance::<P, N>::deploy_builder(__provider)
    }
    /**A [`IMevSafeERC1271`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IMevSafeERC1271`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IMevSafeERC1271Instance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IMevSafeERC1271Instance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IMevSafeERC1271Instance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IMevSafeERC1271Instance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IMevSafeERC1271Instance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IMevSafeERC1271Instance<P, N> {
            IMevSafeERC1271Instance {
